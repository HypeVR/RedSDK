...
public:
    ...
    void *raw_host_mem; //CL_MEM_READ: sized from r3dsdk buffer
    cl_mem raw_device_mem;  //CL_MEM_READ: sized from r3dsdk buffer
...
public:
    ...
    //compiledKernelCacheFolder is a folder path to where you want us to store and load our compiled kernel files on disk. - if you provide "" caching of compiled kernels will be disabled.
