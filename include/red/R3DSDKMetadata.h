...
static const char RMD_ANAMORPHIC_MODE[] =				"anamorphic_mode";				// different from of pixel aspect ratio. 0 = not anamorphic, 1 = 2x, 2 = 1.3x, 3 = 1.25x
...
static const char RMD_ISO_CALIBRATION_VERSION[] =		"iso_calibration_version";		// 1 = V1: original pre-Helium system, 2 = V2: Helium system
